...
var PxController = function(config, module){
	//if (config.modelName == null || config.modelName === undefined) throw new Error("Model cannot be null!");
	var self = {
		...
		_baseInit: function(){
			...
			if (config.skipDefaultActionsInit===false || config.skipDefaultActionsInit===undefined || config.skipDefaultActionsInit == null){
				...
				self.find = function(_query, _ipp, _page, callback){
				...
				self.findPost = function(_query, _ipp, _page, callback){
                    if (typeof(_ipp) == "function") {
                        callback = _ipp;
                        _ipp = undefined;
                        _page = undefined;
